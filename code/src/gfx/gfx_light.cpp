...
* \par Details: 
*/
GFX::Element::Light::Light() :
    m_Intensity(100.0f)
{
    m_Color = glm::vec3(1.0f, 1.0f, 1.0f);
    m_Position = glm::vec3{ 1.5f, 3.5f, 3.0f };
}
...
* \par Details: 
*/
void GFX::Element::Light::Update(GFX::Util::Shader* shader)
{
    shader->SetVector3(m_Position, "lightPosition");
    shader->SetVector3(m_Color * m_Intensity, "lightColor");
}
