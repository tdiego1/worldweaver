...
* \par Details: 
*/
bool GFX::Render::UIContext::Initialize(GFX::Window::BaseWindow* window)
{
...
* \par Details: 
*/
void GFX::Render::UIContext::PreRender()
{
...
* \par Details: 
*/
void GFX::Render::UIContext::Render()
{
    // Rendering
    ImGui::Render();
